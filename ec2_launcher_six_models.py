...
def return_args_trainers_dlrm(
    ...
    for i in range(len(private_ip_trainers)):
        ...
        info = {"cmd": "git clone https://github.com/Jesse-Yan/dlrm.git && cd dlrm && bash run_trainers_dlrm.sh {} {} {} {}".format(batch_size, master_ip, len(private_ip_trainers), log_file_name)}
...
def return_args_trainers_wdn(
    ...
    for i in range(len(private_ip_trainers)):
        if i == 0:
            ...
            master_ip = private_ip_trainers[0]
        info = {"cmd": "git clone https://github.com/Jesse-Yan/dlrm.git && cd dlrm && bash run_trainers_wdn.sh {} {} {} {}".format(batch_size, master_ip, len(private_ip_trainers), log_file_name)}
        run_args_trainers.append(info)
    return run_args_trainers
...
def return_args_trainers_dcn(
    ...
    for i in range(len(private_ip_trainers)):
        if i == 0:
            ...
            master_ip = private_ip_trainers[0]
        info = {"cmd": "rm -rf dlrm && git clone https://github.com/Jesse-Yan/dlrm.git && cd dlrm && bash run_trainers_dcn.sh {} {} {} {}".format(batch_size, master_ip, len(private_ip_trainers), log_file_name)}
        run_args_trainers.append(info)
    return run_args_trainers
...
def return_args_trainers_dfm(
    ...
    for i in range(len(private_ip_trainers)):
        if i == 0:
            ...
            master_ip = private_ip_trainers[0]
        info = {"cmd": "rm -rf dlrm && git clone https://github.com/Jesse-Yan/dlrm.git && cd dlrm && bash run_trainers_dfm.sh {} {} {} {}".format(batch_size, master_ip, len(private_ip_trainers), log_file_name)}
        run_args_trainers.append(info)
    return run_args_trainers
